<?php
/**
 * Registers the agent-flow/sample-dynamic block.
 *
...
use AGENT_FLOW\Includes\Block_Base;
use WP_Block;

/**
 *  Class for the agent-flow/sample-dynamic block.
 */
class Sample_Dynamic extends Block_Base {
	...
	protected function setup_hooks() {
		add_filter( 'agent_flow_gutenberg_blocks_config', array( $this, 'localize_block_data' ) );
	}

...
class Assets {
	...
	public function move_scripts_to_footer() {
		...
		wp_enqueue_script( 'jquery', '/wp-includes/js/jquery/jquery.min.js', array(), AGENT_FLOW_THEME_VERSION, true );
	}
	...
	public function hook_critical_css() {
		...
		$response = wp_remote_get( AGENT_FLOW_BUILD_URI . '/inline.css' );   // load template output in buffer.

		if ( ! is_wp_error( $response ) ) {
			$css = wp_remote_retrieve_body( $response );
			wp_register_style( 'agent-flow-inline-css', false, array(), true, true );
			wp_add_inline_style( 'agent-flow-inline-css', $css );
			wp_enqueue_style( 'agent-flow-inline-css' );
		}
	}
	...
	public function register_styles() {
		...
		// Register styles.
		wp_register_style( 'main-css', AGENT_FLOW_BUILD_URI . '/main.css', array(), filemtime( AGENT_FLOW_BUILD_PATH . '/main.css' ), 'all' );
	...
	public function register_scripts() {
		// Register scripts.
		wp_register_script( 'main-js', AGENT_FLOW_BUILD_URI . '/main.js', array( 'jquery' ), filemtime( AGENT_FLOW_BUILD_PATH . '/main.js' ), true );
	...
	public function enqueue_editor_assets() {
		...
		if ( is_admin() ) {
			wp_enqueue_style(
				...
				AGENT_FLOW_BUILD_URI . '/geditor.css',
				array(),
				filemtime( AGENT_FLOW_BUILD_PATH . '/geditor.css' ),
				'all'
			);
		}

...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'agent-flow' ); ?></a>

	<header id="masthead" class="agent-flow-header site-header u-bg-white">
		<div class="container">
